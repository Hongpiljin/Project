...
<meta charset="UTF-8">
<title>내정보 수정</title>
<link rel="stylesheet" type="text/css" href="css/updateUserView.css?v=2">
<!-- 페이지 제목 설정: "내정보 수정" -->
...
<body>
		...
		<form action="./updateUser.do" method="post">
			...
			<div class="form-group">
				...
				<c:if test="${not empty error}">
					<p class="message error active">${error}</p>
				</c:if>
			...
			<div class="form-buttons">
				<button type="submit" class="yellow-button">수정</button>
				<!-- 서버로 폼 데이터 전송 -->
				<button type="button" onclick="location.href='mypageView.do';"
					class="gray-button">취소</button>
	...
	<script src="script/updateUserView.js"></script>
